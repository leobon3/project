<div class="container p-4">
    ...
    <div class="col-lg-8">
        <form name="changePass" action="changePass.php" method="POST">
            <div class="">
                ...
                <div class="input-group">
                    <input type="password" class="form-control rounded-0 z-0 aa" id="currentPass" name="currentPass"
                        required>
                    <i class="bx bxs-show z-4 position-absolute end-0 pt-2 pe-3 mt-1" id="eye1"
                        onclick="showPass('currentPass', 'eye1')"></i>
                </div>
            </div>
            <div class="">
            ...
            <input class="btn btn-primary mt-2 mb-3" type="submit" name="changePass" value="Save Password">
        </form>
        <hr>
    </div>
</div>
